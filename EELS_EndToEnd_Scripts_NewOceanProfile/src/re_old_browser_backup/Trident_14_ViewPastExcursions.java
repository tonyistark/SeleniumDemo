...
public class Trident_14_ViewPastExcursions {

    public WebDriver driver;
    private Logger Log = Logger.getLogger(Trident_14_ViewPastExcursions.class.getName());

@Test
public  void ViewPastExcursions() {
