...
public class AssemblyStationPageModel {
	...
	public WebElement assemblyStationsTitle(){
		return IResourceConstant.CURRENT_BROWSER.findElement(By.xpath("//*[contains(text(),'Safety Assembly Stations')]"));
	}
