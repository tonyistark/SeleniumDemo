...
public class Trident_Profile_change_Password_98975 {

	private static Logger Log = Logger.getLogger(Trident_Profile_change_Password_98975.class.getName());
    
	  @Test
	  public void Profile_change_Password() {
		   ...
		   Controller.signIn("test-usser132@accenture.com", "Welcome1");
