...
public class Trident_SignupPage_Invalid_Email_Address_98979 {
	private Logger Log = Logger.getLogger(Trident_SignupPage_Invalid_Email_Address_98979.class.getName());
