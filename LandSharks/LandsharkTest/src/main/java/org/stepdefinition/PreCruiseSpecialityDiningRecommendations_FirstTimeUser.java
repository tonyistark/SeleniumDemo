...
public class PreCruiseSpecialityDiningRecommendations_FirstTimeUser {
  ...
  static List<String> exp_values = new ArrayList<String>(); 
   static List<String> actual_values = new ArrayList<String>();  
    ...
    public static void hiturl() throws IOException, Throwable{
		...
		*/
		URL url = new URL("http://52.200.91.61/redirector.php?placements=category_page.precruise_mealreservations&apiKey=364113acb8e80040&apiClientKey=594bd736d0b8be36&sessionId=1238&excludeHTML=true&userId=tty123&userAttribute=activity_type:Relaxation;Fishing&categoryId=reminders&count=999&filterAtr=voyage_no:1606");
