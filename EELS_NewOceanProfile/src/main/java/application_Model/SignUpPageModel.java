...
public class SignUpPageModel {
	...
	public WebElement signUpFirstName() {
		return IResourceConstant.CURRENT_BROWSER
				.findElement(By.xpath("//input[contains(@id,'undefined-undefined-FirstName')]"));
	}

	public WebElement signUpLastName() {
		return IResourceConstant.CURRENT_BROWSER
				.findElement(By.xpath("//input[contains(@id,'undefined-undefined-LastName')]"));
	}

	public WebElement signUpEmailAddress() {
		return IResourceConstant.CURRENT_BROWSER
				.findElement(By.xpath("//input[contains(@id,'undefined-undefined-EmailAddress')]"));
	}

	public WebElement signUpFirstNameLabel() {
		return IResourceConstant.CURRENT_BROWSER
				.findElement(By.xpath("//label[contains(@for,'undefined-undefined-FirstName')]"));
	}

	public WebElement signUpLastNameLabel() {
		return IResourceConstant.CURRENT_BROWSER
				.findElement(By.xpath("//label[contains(@for,'undefined-undefined-LastName')]"));
	}

	public WebElement signUpEmailAddressLabel() {
		return IResourceConstant.CURRENT_BROWSER
				.findElement(By.xpath("//label[contains(@for,'undefined-undefined-EmailAddress')]"));
	}
	...
	public WebElement signUpButton() {
		// return
		// IResourceConstant.CURRENT_BROWSER.findElement(By.id("layout__transitionContainer___2PFZ3"));
		return IResourceConstant.CURRENT_BROWSER.findElement(By.cssSelector(
				"#login > div > div.introduction__bubbles___2siLn > div > div > div.login__fields___2T_LR > div:nth-child(6) > div > button > div > div"));
	}

	public WebElement logInEmailAddress() {
		// return
		// IResourceConstant.CURRENT_BROWSER.findElement(By.id("undefined-undefined-EmailAddress-33524"));
		return IResourceConstant.CURRENT_BROWSER
				.findElement(By.xpath("//input[contains(@id,'undefined-undefined-EmailAddress')]"));
	...
	public WebElement logInPassword() {
		// return
		// IResourceConstant.CURRENT_BROWSER.findElement(By.id("undefined-undefined-Password-7158"));
		return IResourceConstant.CURRENT_BROWSER
				.findElement(By.xpath("//input[contains(@id,'undefined-undefined-Password')]"));

	}

	public WebElement logInbtn() {
		return IResourceConstant.CURRENT_BROWSER.findElement(By.xpath("//*[text()='Log In']"));
	...
	public WebElement shipsExperiences() {
		return IResourceConstant.CURRENT_BROWSER
				.findElement(By.xpath("//div[contains(text(), 'Ships & Experiences' )]"));
	...
	public WebElement ocean() {
		return IResourceConstant.CURRENT_BROWSER
				.findElement(By.xpath(".//*[@id='layout']/div[1]/div/div[3]/div[1]/button[4]"));
		//// div[contains(text(), 'O�C�E�A�N' )]
	}
	...
	public WebElement loginFuncErrorMessage() {
		return IResourceConstant.CURRENT_BROWSER.findElement(By.cssSelector(
				"#login > div > div.introduction__bubbles___2siLn > div > div > div.login__fields___2T_LR > div:nth-child(4) > div:nth-child(4)"));
	...
	public WebElement explicitly(){
		return IResourceConstant.CURRENT_BROWSER.findElement(By.cssSelector("//*[@id='layout']/div[1]/div/div[1]/svg/path[1]"));
	
	}
		
	public WebElement princessLogoButton(){
		
		return IResourceConstant.CURRENT_BROWSER.findElement(By.xpath(".//*[@id='layout']/div[1]/div/div[1]/svg/path[1]"));
}
	public WebElement myCompassButton()
	{
		return IResourceConstant.CURRENT_BROWSER.findElement(By.xpath("//*[@id='layout']/div[1]/div/div[3]/div[1]/button[5]/div/div"));
	}
