...
public class Trident_Profile_change_UserName_Duplicate_Email_98974 {

	private static Logger Log = Logger.getLogger(Trident_Profile_change_UserName_Duplicate_Email_98974.class.getName());
    
	  @Test
	  public void Profile_change_UserName_Duplicate_Email() {
		   ...
		   Controller.signIn("test-suser2@accenture.com", "Welcome1");
