...
public class Trident_SignupPage_Invalid_First_Name_98980 {
	private Logger Log = Logger.getLogger(Trident_SignupPage_Invalid_First_Name_98980.class.getName());
	...
	public void SignupPage_Invalid_First_Name() throws IOException {
		...
		signUpPageController.enterFirstNameSignUp("4asd");
		signUpPageController.enterLastNameSignUp("gupta");
		signUpPageController.enterEmailIdLogIn("abcc@email.com");
		signUpPageController.clickSignUpButton();
		// Assert.assertEquals(signUpPageController.getLogInError(), "Required
