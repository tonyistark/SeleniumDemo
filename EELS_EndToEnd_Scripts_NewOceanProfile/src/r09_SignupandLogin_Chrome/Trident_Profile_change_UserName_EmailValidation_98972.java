...
public class Trident_Profile_change_UserName_EmailValidation_98972 {

	private static Logger Log = Logger.getLogger(Trident_Login_Page_EmailAddress_Not_Registered_99030.class.getName());
    
	  @Test
	  public void Profile_change_UserName_EmailValidation() {
		   ...
		   Controller.signIn("testx-usesr32@accenture.com", "Welcome1");
