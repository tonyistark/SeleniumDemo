...
public class Trident_1_ViewUpdatedItinerary_BookRecommendation_64494 {

    private Logger Log = Logger.getLogger(Trident_1_ViewUpdatedItinerary_BookRecommendation_64494.class.getName());
...
//   Controller.waitForLoad();
 ...
 //TO DO- Add the string validation for the already booked excursion
