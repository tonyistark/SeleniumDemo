...
public class Trident_Profile_change_Password_DataMismatch_Error_98976 {

	private static Logger Log = Logger.getLogger(Trident_Profile_change_Password_DataMismatch_Error_98976.class.getName());
    
	  @Test
	  public void Profile_change_Password_DataMismatch_Error() {
		   ...
		   Controller.signIn("test-ufser132@accenture.com", "Welcome1");
