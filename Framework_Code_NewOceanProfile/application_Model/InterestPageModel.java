...
public static WebElement youthTeenAcitivities() {
	...
	return IResourceConstant.CURRENT_BROWSER.findElement(By.xpath("//span[@data-name = 'Youth & Teen Activities']"));
}

public static WebElement desc() {
	
	return IResourceConstant.CURRENT_BROWSER.findElement(By.xpath("//h1[text()='Tell us a little about yourself.']"));
}
