...
public class RecommendationController {
	...
	/*
	public int noOfSimilarTimeslots(){
		return RecommendationModel.similarTimeslots().size();
	}
	
	public void getsimilarTimeslots(){
		 if(noOfSimilarTimeslots()>0)
			  for(int i=0;i<noOfSimilarTimeslots();i++)
			  {
			   String str = RecommendationModel.similarTimeslots().get(i).getText();
