...
public class HousekeepingSetupPageModel {
	...
	public WebElement housekeepingSetupTitle(){
		return IResourceConstant.CURRENT_BROWSER.findElement(By.xpath("(//*[contains(text(),'Housekeeping Setup')])[2]"));
	}
