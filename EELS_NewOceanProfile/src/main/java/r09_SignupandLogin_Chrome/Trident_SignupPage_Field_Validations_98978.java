...
public class Trident_SignupPage_Field_Validations_98978 {
	...
	private Logger Log = Logger.getLogger(Trident_SignupPage_Field_Validations_98978.class.getName());
	 ...
	 @Test
		 ...
		 Assert.assertEquals(signUpPageController.getIntroductionMessage(),"On Medallion-class ships, the Compass is your companion.");
