...
public class Trident_2_ViewUpdaedItinerary_BookRecommendation {
	 private Logger Log = Logger.getLogger(Trident_2_ViewUpdaedItinerary_BookRecommendation.class.getName());

	 @Test
	 public  void ViewUpdatedItinerary() {
	   ...
	   Controller.waitForLoad();
	 	...
	 	//	String booked_excursion = driver.findElement(By.xpath(".//*[@id='modal']/div/div/div/div[2]/div[1]/div[2]/div[2]/div[1]")).getText(); 
	 	   RecommendationController.clickFirstRecommendation();
	 		// click on purchase
	 		  ...
	 		  Controller.waitForLoad();
	 		//Validate that booked excursion is appearing on the Itinerary
	 	//	String event_title = driver.findElement(By.xpath(".//*[@id='voyage-subview-root']/div[2]/div[2]/div[1]/div[2]/div[2]/div[1]/div[2]/div[1]")).getText();
