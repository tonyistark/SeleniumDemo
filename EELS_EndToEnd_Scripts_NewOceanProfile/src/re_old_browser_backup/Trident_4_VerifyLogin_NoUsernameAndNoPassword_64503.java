...
public class Trident_4_VerifyLogin_NoUsernameAndNoPassword_64503 {
	     
    private static Logger Log = Logger.getLogger(Trident_4_VerifyLogin_NoUsernameAndNoPassword_64503.class.getName());
//FileAppender appender = (FileAppender)Log.getAppender("E2EPOC_WithTestNG");
    //return new File(appender.getFile());
       
  @Test
  public void NoUsernameAndNoPassword() {
