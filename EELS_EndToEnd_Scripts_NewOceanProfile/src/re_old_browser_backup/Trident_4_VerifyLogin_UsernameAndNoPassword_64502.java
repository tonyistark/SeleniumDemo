...
public class Trident_4_VerifyLogin_UsernameAndNoPassword_64502 {
	     
    private static Logger Log = Logger.getLogger(Trident_4_VerifyLogin_UsernameAndNoPassword_64502.class.getName());
