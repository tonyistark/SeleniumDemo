...
public class Trident_3_ViewRecommendationsExcursions_BasedOnItemLevel_64500 {
...
private static  Logger Log = Logger.getLogger(Trident_3_ViewBookedExcursions_ItemLevel_64499.class.getName());
   ...
   Controller.waitForLoad();
     ...
     //Validate event
     String recom = RecommendationController.recommValidation();
     
     JourneyPage.clickDay5();		 
     Controller.waitForLoad();
    ...
    //Validate event
    String recom2 = RecommendationController.recommValidation();
     
     String bookrecom = RecommendationController.bookRecommValidation();
     
     Assert.assertEquals(recom, recom2);
