...
public class SignUpPageController {
	...
	public void signIn() {
		signIn("karan.chauhan@accenture.com", "testuser123");
	}
	...
	public void explicitlywait(){
		...
		WebElement element = wait.until(ExpectedConditions.elementToBeClickable(signUpPageModel.explicitly()));
	}
	public String enteredUsername(){
		return signUpPageModel.logInEmailAddress().getAttribute("value");
	}
	public void url(){
		 IResourceConstant.CURRENT_BROWSER.get(IResourceConstant.WEB_URL);
	}
	public void clickPrincessLogo()
	{
		signUpPageModel.princessLogoButton().click();
	}
	public void clickMyCompass()
	{
		signUpPageModel.myCompassButton().click();
	}
	public void learnPlan(){
		signUpPageModel.learnPlan().click();
	}
}
