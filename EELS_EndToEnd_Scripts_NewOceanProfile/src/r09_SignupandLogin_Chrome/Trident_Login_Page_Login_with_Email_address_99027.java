...
public class Trident_Login_Page_Login_with_Email_address_99027 {

	private static Logger Log = Logger.getLogger(Trident_Login_Page_Login_with_Email_address_99027.class.getName());

	@Test
	public void Trident_Login_PageLogin_with_Email_address() {

		SignUpPageController controller = new SignUpPageController();
		controller.clickLogInBubble();
		controller.signIn("rishi.a.garg@accenture.com", "");
		Assert.assertEquals(true, controller.logInButtonDisplayed());
		Assert.assertEquals(controller.getLogInFuncError(), "Password cannot be blank");
	}
